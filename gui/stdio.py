...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-aywa create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-aywa setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-aywa setconfig' to change your settings")
        return True
